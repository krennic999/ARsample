...
from autoregressive.models.generate_motivation import generate
import random
import pdb
import json
    ...
    for item in batched_data:
        ...
        with torch.no_grad():
            ...
            index_sample, entropy_list = generate(
                ...
                top_p=args.top_p, entropy_range=args.entropy_range, temperature_value=args.temperature_value, sample_logits=True
            )
            if rank == 0:
        ...
        savedir_pred = os.path.join(args.save_root, 'prediction_entropy_range%s_tempvalue%s'%(str(args.entropy_range).replace(' ',''),args.temperature_value))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--entropy_range", type=list, default=[[8,100]], help="entropy to sample with")
    parser.add_argument("--temperature_value", type=list, default=[1.5], help="entropy to sample with")
    parser.add_argument("--cfg_value", type=list, default=[1.5], help="entropy to sample with")
