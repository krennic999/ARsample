...
def get_jacobi_param_dict():
    ...
    is_entropy_acc=False#True
    save_NFE_dir='test_llamagen_nfe_%s_entropy%s.txt'%(multi_token_init_scheme,is_entropy_acc)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--t5-path", type=str, default='/your-ckpt/google/')
    ...
    parser.add_argument("--gpt-ckpt", type=str, default='/your-ckpt/LlamaGen/t2i_XL_stage2_512.pt')
    ...
    parser.add_argument("--vq-ckpt", type=str, default='/your-ckpt/LlamaGen/vq_ds16_t2i.pt', help="ckpt path for vq model")
