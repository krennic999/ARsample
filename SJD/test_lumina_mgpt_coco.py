...
def generate(
    ...
    logits_processor=inference_solver.create_logits_processor(cfg=args.cfg_scale, image_top_k=args.image_topk)
...
def main(args):
    ...
    multi_token_init_scheme = 'sample_horizon'#'random'#'sample_horizon'#'random' # 'repeat_horizon'
    ...
    inference_solver = renew_pipeline_sampler(
        ...
        jacobi_loop_interval_r = (args.image_size // 16)**2 + args.image_size // 16 - 10,
        max_num_new_tokens = max_num_new_tokens,
        guidance_scale = guidance_scale,
        save_NFE_dir = args.save_NFE_dir,
        if_entropy_acc = args.is_entropy_acc,
        seed = seed,
    ...
    for item in batched_data:
        ...
        for idx in effective_idx:#i, (fname, text_prompt) in enumerate(zip(name, text_prompts)):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_topk", type=float, default=2000)
    ...
    parser.add_argument("--save_root", type=str, default='/your-save-root/entropy_cfg4_sample_sjd_top2000_1024_v2_ab2')
    parser.add_argument("--save_NFE_dir", type=str, default='/your-save-root/entropy_cfg4_sample_sjd_top2000_1024_v2_ab2.txt')
