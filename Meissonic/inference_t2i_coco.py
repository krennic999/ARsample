...
def main(args):
    ...
    for item in batched_data:
        ...
        savedir_pred = os.path.join(args.save_root, 'prediction_cfg%2f_topk%d_topp%2f_temp%2f_seed%d_entropy%s'%(args.cfg_scale,args.top_k,args.top_p,args.temperature,args.seed,args.enable_entropy_filtering))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_root", type=str, default='/your-save-root/seed_test_coco17')
